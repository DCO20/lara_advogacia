        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    ...
                    <a class="btn animated fadeInUp" href="#">Entre em contato</a>
                </div>
            </div>

            <div class="carousel-item">
                <img src="{{ url(asset('assets/img/carousel-2.jpg'))}}" alt="Carousel Image">
                <div class="carousel-caption">
                    <h1 class="animated fadeInLeft">Estamos preparados para nos opor por você</h1>
                    <p class="animated fadeInRight">Lorem ipsum dolor sit amet elit. Mauris odio mauris...</p>
                    <a class="btn animated fadeInUp" href="#">Entre em contato</a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <div class="about-img">
                        <img src="{{ url(asset('assets/img/about.jpg'))}}" alt="Image">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="feature-img">
                        <img src="{{ url(asset('assets/img/feature.jpg'))}}" alt="Feature">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="faqs">
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="faqs-img">
                        <img src="{{ url(asset('assets/img/faqs.jpg'))}}" alt="Image">
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="section-header">
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonials-carousel">
                <div class="testimonial-item">
                    ...
                    <div class="row align-items-center">
                        <div class="col-3">
                            <img src="{{ url(asset('assets/img/testimonial-1.jpg'))}}" alt="">
                        </div>
                        <div class="col-9">
                            <h2>Client Name</h2>
                            <p>Profession</p>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="row align-items-center">
                        <div class="col-3">
                            <img src="{{ url(asset('assets/img/testimonial-2.jpg'))}}" alt="">
                        </div>
                        <div class="col-9">
                            <h2>Client Name</h2>
                            <p>Profession</p>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="row align-items-center">
                        <div class="col-3">
                            <img src="{{ url(asset('assets/img/testimonial-3.jpg'))}}" alt="">
                        </div>
                        <div class="col-9">
                            <h2>Client Name</h2>
                            <p>Profession</p>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="row align-items-center">
                        <div class="col-3">
                            <img src="{{ url(asset('assets/img/testimonial-4.jpg'))}}" alt="">
                        </div>
                        <div class="col-9">
                            <h2>Client Name</h2>
                            <p>Profession</p>
        ...
        <div class="container">
            ...
            <div class="owl-carousel blog-carousel">
                <div class="blog-item">
                    ...
                    <a class="btn" href="">Saiba mais <i class="fa fa-angle-right"></i></a>
                </div>
                <div class="blog-item">
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        <form>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Digite o assunto" required="required" />
                            </div>
                            <div class="form-group">
